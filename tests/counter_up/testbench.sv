...
module testbench();
   ...
   assign error_counter_o = (count_o !== correct_count_o);
...
`endif
   ...
   always @(negedge clk_i) begin
      ...
      if(reset_done & !reset_i & error_counter_o) begin
	    $display("\033[0;31mError!\033[0m: count_o should be %b, got %b", correct_count_o, count_o);
      end else if (reset_i & error_counter_o) begin
	    $display("\033[0;31mError!\033[0m: count_o should be %b during reset, got %b", correct_count_o, count_o);
      end
   end
