...
VL_INLINE_OPT VlCoroutine Vtestbench___024root___eval_initial__TOP__0(Vtestbench___024root* vlSelf) {
    ...
    if (vlSelf->testbench__DOT__up_i) {
        vlSelf->testbench__DOT__correct_count_o = (
                                                   (0xfU 
    ...
    VL_WRITEF("At Posedge           0: correct_count_o = %b, reset_i = %b \n",
              8,vlSelf->testbench__DOT__correct_count_o,
...
VL_INLINE_OPT void Vtestbench___024root___nba_sequent__TOP__0(Vtestbench___024root* vlSelf) {
    ...
    if ((1U & (~ (((IData)(vlSelf->testbench__DOT__reset_done) 
                  ...
                  & (IData)(vlSelf->testbench__DOT__error_counter_o))))) {
    ...
    if (VL_UNLIKELY((((IData)(vlSelf->testbench__DOT__reset_done) 
                      & (~ (IData)(vlSelf->testbench__DOT__reset_i))) 
                     & (IData)(vlSelf->testbench__DOT__error_counter_o)))) {
        VL_WRITEF("\033[0;31mError!\033[0m: data_o should be %b, got %b\n",
                  8,vlSelf->testbench__DOT__correct_count_o,
                  8,(IData)(vlSelf->testbench__DOT__count_o));
        vlSelf->testbench__DOT__error_counter_o = 1U;
    } else if (VL_UNLIKELY(((IData)(vlSelf->testbench__DOT__reset_i) 
                            & (IData)(vlSelf->testbench__DOT__error_counter_o)))) {
        VL_WRITEF("\033[0;31mError!\033[0m: data_o should be %b during reset, got %b\n",
                  8,vlSelf->testbench__DOT__correct_count_o,
                  8,(IData)(vlSelf->testbench__DOT__count_o));
        vlSelf->testbench__DOT__error_counter_o = 1U;
    }
...
VL_INLINE_OPT void Vtestbench___024root___nba_sequent__TOP__3(Vtestbench___024root* vlSelf) {
    ...
    vlSelf->testbench__DOT__dut__DOT__counter_up_chart__DOT__count_r 
...
VL_INLINE_OPT void Vtestbench___024root___nba_comb__TOP__1(Vtestbench___024root* vlSelf) {
    ...
    // Body
    vlSelf->testbench__DOT__dut__DOT__counter_up_chart__DOT__count_n 
        = (0x7fU & ((IData)(vlSelf->testbench__DOT__up_i)
                     ? ((IData)(1U) + (IData)(vlSelf->testbench__DOT__dut__DOT__counter_up_chart__DOT__count_r))
                     : (IData)(vlSelf->testbench__DOT__dut__DOT__counter_up_chart__DOT__count_r)));
