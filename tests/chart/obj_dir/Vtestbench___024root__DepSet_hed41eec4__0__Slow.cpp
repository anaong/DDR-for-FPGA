...
VL_ATTR_COLD void Vtestbench___024root___ctor_var_reset(Vtestbench___024root* vlSelf) {
    ...
    vlSelf->testbench__DOT__count_o = VL_RAND_RESET_I(8);
    ...
    vlSelf->testbench__DOT____Vtogcov__count_o = VL_RAND_RESET_I(8);
    ...
    vlSelf->testbench__DOT__dut__DOT____Vtogcov__next_i = VL_RAND_RESET_I(1);
    vlSelf->testbench__DOT__dut__DOT____Vtogcov__rd_addr_w = VL_RAND_RESET_I(7);
    vlSelf->testbench__DOT__dut__DOT__counter_up_chart__DOT__count_r = VL_RAND_RESET_I(7);
    vlSelf->testbench__DOT__dut__DOT__counter_up_chart__DOT__count_n = VL_RAND_RESET_I(7);
    vlSelf->testbench__DOT__dut__DOT__counter_up_chart__DOT____Vtogcov__reset_i = VL_RAND_RESET_I(1);
    vlSelf->testbench__DOT__dut__DOT__counter_up_chart__DOT____Vtogcov__count_n = VL_RAND_RESET_I(7);
    for (int __Vi0 = 0; __Vi0 < 8; ++__Vi0) {
        vlSelf->testbench__DOT__dut__DOT__rom_inst__DOT__mem_l[__Vi0] = VL_RAND_RESET_I(8);
    }
    for (int __Vi0 = 0; __Vi0 < 8; ++__Vi0) {
        vlSelf->testbench__DOT__dut__DOT__rom_inst__DOT____Vtogcov__mem_l[__Vi0] = VL_RAND_RESET_I(8);
    }
