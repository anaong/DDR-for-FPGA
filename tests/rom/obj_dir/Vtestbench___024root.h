...
class Vtestbench___024root final : public VerilatedModule {
  public:
    ...
    CData/*7:0*/ testbench__DOT__rd_data_o;
    CData/*2:0*/ testbench__DOT__rd_addr_i;
    ...
    CData/*7:0*/ testbench__DOT____Vtogcov__rd_data_o;
    CData/*2:0*/ testbench__DOT____Vtogcov__rd_addr_i;
    ...
    VlUnpacked<CData/*7:0*/, 8> testbench__DOT__dut__DOT__mem_l;
    VlUnpacked<CData/*7:0*/, 8> testbench__DOT__dut__DOT____Vtogcov__mem_l;
