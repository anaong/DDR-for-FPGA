...
int main(int argc, char* argv[]) {
    ...
    sdl_window = SDL_CreateWindow("DDR", SDL_WINDOWPOS_CENTERED,
    ...
    while (1) {
        ...
        if (top->sdl_sy == V_RES && top->sdl_sx == 0) {
            ...
            top->btn_up = keyb_state[SDL_SCANCODE_F];
            top->btn_dn = keyb_state[SDL_SCANCODE_J];
            top->btn_fire = keyb_state[SDL_SCANCODE_D];
            top->sim_rst = keyb_state[SDL_SCANCODE_K];
