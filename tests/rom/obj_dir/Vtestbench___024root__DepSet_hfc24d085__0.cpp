...
VL_INLINE_OPT VlCoroutine Vtestbench___024root___eval_initial__TOP__0(Vtestbench___024root* vlSelf) {
    ...
    vlSelf->testbench__DOT__rd_addr_i = 0U;
    ...
    co_await vlSelf->__VtrigSched_hef748430__0.trigger(
                                                       ...
                                                       "testbench.sv", 
                                                       72);
    vlSelf->testbench__DOT__rd_addr_i = (7U & ((IData)(1U) 
                                               + (IData)(vlSelf->testbench__DOT__rd_addr_i)));
                                               ...
                                               | (0xf0U 
                                                  & (((IData)(1U) 
                                                      ...
                                                      ((IData)(vlSelf->testbench__DOT__correct_count_o) 
                                                       >> 4U)) 
                                                     << 4U)));
    vlSelf->testbench__DOT__correct_count_o = ((0xf0U 
                                                & (IData)(vlSelf->testbench__DOT__correct_count_o)) 
                                               | (0xfU 
                                                  & ((IData)(1U) 
                                                     + (IData)(vlSelf->testbench__DOT__correct_count_o))));
...
VL_INLINE_OPT void Vtestbench___024root___nba_sequent__TOP__0(Vtestbench___024root* vlSelf) {
    ...
    if (VL_UNLIKELY((((IData)(vlSelf->testbench__DOT__reset_done) 
                      & (~ (IData)(vlSelf->testbench__DOT__reset_i))) 
                     & (IData)(vlSelf->testbench__DOT__error_counter_o)))) {
        VL_WRITEF("\033[0;31mError!\033[0m: rd_data_o should be %b, got %b\n",
                  8,vlSelf->testbench__DOT__correct_count_o,
                  8,(IData)(vlSelf->testbench__DOT__rd_data_o));
        vlSelf->testbench__DOT__error_counter_o = 1U;
    } else if (VL_UNLIKELY(((IData)(vlSelf->testbench__DOT__reset_i) 
                            & (IData)(vlSelf->testbench__DOT__error_counter_o)))) {
        VL_WRITEF("\033[0;31mError!\033[0m: rd_data_o should be %b during reset, got %b\n",
                  8,vlSelf->testbench__DOT__correct_count_o,
                  8,(IData)(vlSelf->testbench__DOT__rd_data_o));
        vlSelf->testbench__DOT__error_counter_o = 1U;
    }
