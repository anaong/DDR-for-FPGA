...
class Vtestbench___024root final : public VerilatedModule {
  public:
    ...
    CData/*7:0*/ testbench__DOT__count_o;
    CData/*7:0*/ testbench__DOT__correct_count_o;
    CData/*0:0*/ testbench__DOT__error_counter_o;
    ...
    CData/*7:0*/ testbench__DOT____Vtogcov__count_o;
    CData/*7:0*/ testbench__DOT____Vtogcov__correct_count_o;
    ...
    CData/*0:0*/ testbench__DOT__dut__DOT____Vtogcov__next_i;
    CData/*6:0*/ testbench__DOT__dut__DOT____Vtogcov__rd_addr_w;
    CData/*6:0*/ testbench__DOT__dut__DOT__counter_up_chart__DOT__count_r;
    CData/*6:0*/ testbench__DOT__dut__DOT__counter_up_chart__DOT__count_n;
    CData/*0:0*/ testbench__DOT__dut__DOT__counter_up_chart__DOT____Vtogcov__reset_i;
    CData/*6:0*/ testbench__DOT__dut__DOT__counter_up_chart__DOT____Vtogcov__count_n;
    ...
    VlUnpacked<CData/*7:0*/, 8> testbench__DOT__dut__DOT__rom_inst__DOT__mem_l;
    VlUnpacked<CData/*7:0*/, 8> testbench__DOT__dut__DOT__rom_inst__DOT____Vtogcov__mem_l;
