...
VL_ATTR_COLD void Vtestbench___024root___ctor_var_reset(Vtestbench___024root* vlSelf) {
    ...
    vlSelf->testbench__DOT__correct_count_o = VL_RAND_RESET_I(4);
    ...
    vlSelf->testbench__DOT____Vtogcov__count_o = VL_RAND_RESET_I(4);
    vlSelf->testbench__DOT____Vtogcov__correct_count_o = VL_RAND_RESET_I(4);
    ...
    vlSelf->testbench__DOT__dut__DOT__count_r = VL_RAND_RESET_I(4);
    vlSelf->testbench__DOT__dut__DOT__count_n = VL_RAND_RESET_I(4);
    vlSelf->testbench__DOT__dut__DOT____Vtogcov__up_i = VL_RAND_RESET_I(1);
    vlSelf->testbench__DOT__dut__DOT____Vtogcov__count_n = VL_RAND_RESET_I(4);
